...
parser = argparse.ArgumentParser(description='HiCR-Mamba for high-dimensional time series forecasting')
...
parser.add_argument('--model', type=str, required=True, default='HiCRMamba',
                    help='model name, options: [HiCRMamba]')
...
# Forecasting head and patch settings
...
parser.add_argument('--pm_bidirectional', type=int, default=1, help='HiCR-Mamba bidirectional patch scan')
...
parser.add_argument('--max_grad_norm', type=float, default=0.0, help='gradient clipping max norm; <=0 disables clipping')
